    ...
    <div className="min-h-screen selection:bg-brand-primary selection:text-black relative">
      ...
      <div className="fixed bottom-8 right-8 z-50 flex items-center gap-3">
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-xl shadow-[#25D366]/20 relative group"
        >
          <svg 
            viewBox="0 0 24 24" 
          ...
          <span className="absolute right-full mr-4 px-3 py-1.5 bg-black/80 backdrop-blur-md border border-white/10 text-white text-[10px] font-bold uppercase tracking-widest rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-2 group-hover:translate-x-0 whitespace-nowrap pointer-events-none">
            Chat on WhatsApp
          </span>
        </motion.a>
      </div>
